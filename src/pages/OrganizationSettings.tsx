...
import { Building2, Users, Mail, Save, Trash2, Send, Clock, CheckCircle2, UserPlus } from "lucide-react";
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Send an invitation to join your organization. The invited person must create an account, then their pending invitation will be automatically accepted.
                </CardDescription>
              </CardHeader>
              <CardContent>
