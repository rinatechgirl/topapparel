...
import { Sparkles, Ruler, Users, Palette, Shield, Globe, ArrowRight } from "lucide-react";
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24 lg:pt-28 lg:pb-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl font-display font-extrabold leading-tight tracking-tight mb-6"
            >
